...
else
{
	...
	for(Car c:vcars)
	{
		...
		html=html+"<div id=\""+valornuevo+"\"  class=\"buscarloc campoleft amp-width-350 amp-space-left-30\" estacion=\""+valornuevo2+"\"  ><p>"+c.getStationcheckout().getDescr()+": <strong style=\"float:right;\">"+Formatea.Importe2Decimales(c.getQuote().getTotalRateEstimateInBookingCurrency(),2)+" &#8364;</strong></p>";
